    ...
    <nav aria-label="Tool categories" style="background:#0D1424;border-bottom:1px solid rgba(255,255,255,.06);padding:14px 0;">
        <div class="container">
            <div style="display:flex;flex-wrap:wrap;gap:8px;align-items:center;">
                ...
                <a href="<?php echo esc_url(home_url('/tools/mortgage-calculator/')); ?>" style="display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:5px 12px;font-size:.8rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#127968; Mortgage</a>
                <a href="<?php echo esc_url(home_url('/tools/compound-interest-calculator/')); ?>" style="display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:5px 12px;font-size:.8rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#128200; Investing</a>
                <a href="<?php echo esc_url(home_url('/tools/income-tax-calculator/')); ?>" style="display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:5px 12px;font-size:.8rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#129534; Taxes</a>
                ...
                <a href="<?php echo esc_url(home_url('/tools/monthly-budget-planner/')); ?>" style="display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:5px 12px;font-size:.8rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#128203; Budgeting</a>
                <a href="<?php echo esc_url(home_url('/tools/crypto-pl-calculator/')); ?>" style="display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;padding:5px 12px;font-size:.8rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#8383; Crypto</a>
            </div>
        </div>
    </nav>
