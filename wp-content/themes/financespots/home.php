        ...
        <div class="container">
            <div style="background:#131929;border:1px solid rgba(255,255,255,.08);border-radius:14px;padding:22px 28px;">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:10px;">
                    ...
                    <a href="<?php echo esc_url(home_url('/tool/mortgage-calculator/')); ?>" style="display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:8px;padding:8px 14px;font-size:.84rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#127968; Mortgage</a>
                    <a href="<?php echo esc_url(home_url('/tool/compound-interest-calculator/')); ?>" style="display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:8px;padding:8px 14px;font-size:.84rem;font-weight:600;color:#94A3B8;text-decoration:none;transition:color .2s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#94A3B8'">&#128200; Investing</a>
