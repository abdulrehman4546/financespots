...
define( 'FINANCESPOTS_VERSION', '1.3.0' );
...
/* ── Fix author display name from "admin" to "Abdul Rahman" ── */
add_action( 'init', function() {
    if ( get_option( 'fs_author_name_fixed' ) ) return;
...
function fs_create_blog_posts() {
    if ( get_option('fs_blogs_v4') ) return;
    delete_option('fs_blogs_v3');
    ...
    $posts = [
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/va-loan-funding-fee-calculator/'),'Calculate Your Exact VA Funding Fee Free')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/savings-goal-calculator/'),'Calculate Your Exact Savings Timeline Free')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/mortgage-calculator/'),'See How Your Score Affects Your Mortgage Rate')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/investment-calculator/'),'See How Your Index Fund Investment Grows Over Time')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/budget-analyzer/'),'Try the Free 50/30/20 Budget Analyzer')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/loan-payoff-calculator/'),'Calculate How Fast You Can Pay Off Your Loans')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/crypto-pl-calculator/'),'Calculate Bitcoin Returns at Any Entry Price')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/emergency-fund-calculator/'),'Calculate Your Emergency Fund Target Free')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/mortgage-calculator/'),'Calculate Your Monthly Mortgage Payment Free')
        ...
        [
            ...
            'content' =>
                ...
                . $cta(home_url('/tool/retirement-income-calculator/'),'Find Your Retirement Number and Monthly Savings Target')
    ...
    update_option( 'fs_blogs_v4', true );
}
